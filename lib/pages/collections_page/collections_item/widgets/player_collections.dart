...
class PlayerCollections extends StatelessWidget {
  const PlayerCollections({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Visibility(
      ...
      child: Container(
          ...
          height: context.watch<CollectionsItemPageModel>().getAnim * 75.0,
          ...
          child:
            ...
            Padding(
              ...
              child: SizedBox(
                width: context.watch<CollectionsItemPageModel>().getAnim * 50.0,
                height:
                    context.watch<CollectionsItemPageModel>().getAnim * 50.0,
                child: Image.asset(
                  AppIcons.play_white,
                  fit: BoxFit.fill,
                ),
